...
# 30: a GUI client has to build BEFORE 51-desktop-split.sh deletes the
# headers and libraries it compiles against, and be packaged by
# 50-repo.sh. That is the whole reason those two stages moved to the
# end -- see 50-repo.sh's header.
# ============================================================
set -euo pipefail
